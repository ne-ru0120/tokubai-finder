...
# 全国の主要〜中堅ドラッグストアチェーン名（amenity=pharmacy タグで登録されがちな店）
# ※ 独立の調剤薬局を拾いすぎないよう、ブランド特有の語に限定
CHAINS = (
    "マツモトキヨシ|マツキヨ|サンドラッグ|スギ薬局|スギドラッグ|ココカラファイン|"
    "クリエイト|ウエルシア|ウェルシア|トモズ|ツルハ|セイムス|クスリのアオキ|"
    "ドラッグストアモリ|ドラッグモリ|キリン堂|ゲンキー|ドラッグイレブン|ウェルパーク|コクミン|"
    "コスモス|カワチ|サツドラ|サッポロドラッグ|ダイコクドラッグ|ドラッグユタカ|ハックドラッグ|"
    "B&Dドラッグ|スギヤマ|くすりの福太郎|Vドラッグ|中部薬品|ザグザグ|レデイ|くすりのレデイ|"
    "ププレ|杏林堂|ウォンツ|セガミ|ドラッグセガミ|薬王堂|ぱぱす|新生堂薬局|大賀薬局|アカカベ|"
    "ヤックスドラッグ|サンキュードラッグ|アメリカンドラッグ|スーパードラッグひまわり|"
    "ドラッグストアウェルネス|クスリのサンロード|ドラッグエース|ドラッグフジイ|くすりのマルト|"
    "ドラッグストアバイゴー|キリン堂薬局|ドラッグセイムス")
